...
inputs = tokenizer.encode(sample, return_tensors="pt", max_length=514, truncation=True)
summary_ids = model.generate(inputs, max_length=256, length_penalty=2.0, num_beams=4, early_stopping=True)
