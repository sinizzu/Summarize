...
HJFrontend = settings.HJFrontend
JHFrontend = settings.JHFrontend
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:8500", "http://localhost:3500", MainFastAPI, MainFrontend, HJFrontend, JHFrontend],  # 모든 도메인에서 오는 요청을 허용합니다. 실제로는 필요한 도메인만 허용하도록 변경해야 합니다.
